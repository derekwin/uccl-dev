...
#define DEFAULT_MIN_QP_PER_EP 4
...
#define DEFAULT_THREAD_BLOCK_MAX_COUNT 16

struct Config {
  int rdma_chunk_size;
  int qp_count_min_per_ep;
  ...
  Config()
      : rdma_chunk_size(
        ...
        max_thread_blocks_count(getEnvOrDefault(
            "ECCL_THREAD_BLOCK_MAX_COUNT", DEFAULT_THREAD_BLOCK_MAX_COUNT)) {}
